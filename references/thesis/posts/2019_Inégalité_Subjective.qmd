...
about:
  ...
  links:
    ...
    - icon: file-pdf-fill
      href: https://www.dropbox.com/s/1jpggq0ny7ns0e1/These_RYANEZ.pdf
---
- icon: file
  icon_pack: fa
  name: Documento
  web: https://www.dropbox.com/s/1jpggq0ny7ns0e1/These_RYANEZ.pdf
...
Yanez, Rodrigo (2019). *Inégalité Subjective Au Chili. Représentation Des Différences Sociales (in)Justes à Travers Le Temps*.  Doctorado En Sociología - EHESS. Paris
